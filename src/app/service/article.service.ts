...
export class ArticleService {
  ...
  // CRUD: Get collection
  getArticleListFromDb(): Observable<Article[]> {    // This method creates an Observable to listen for the response from the database,
    return this.http
      .get<any>(`${this.apiUrl}/public_articles`)
